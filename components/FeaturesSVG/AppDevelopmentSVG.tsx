// src/components/icons/AppDevelopmentSVG.tsx
...
const AppDevelopmentSVG: React.FC<IconProps> = ({
  color = "#b5d1ed",
  size = 24,
}) => (
  <svg
    ...
    height={size}
    role="img"
    aria-labelledby="AppDevelopmentTitle"
  >
    <g>
      <path
        fill={color}
...
export default AppDevelopmentSVG;
