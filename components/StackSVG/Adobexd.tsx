// src/components/icons/AdobeXDSVG.tsx
...
const AdobeXDSVG: React.FC<IconProps> = ({ size = 50 }) => (
  <svg
    ...
    width={size}
    height={size}
    fill="#FF61F6" // Keep the fill from the original SVG
    aria-labelledby="AdobeXDTitle"
  >
