...
const GoogleDataStudioSVG: React.FC = () => (
  <svg
    ...
    height={44}
    role="img"
    aria-labelledby="GoogleDataStudioTitle"
  >
    <title id="GoogleDataStudioTitle">Google Data Studio</title>
    <path
...
export default GoogleDataStudioSVG;