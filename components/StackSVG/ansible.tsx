// src/components/icons/AnsibleSVG.tsx
import React from "react";

const AnsibleSVG: React.FC = () => (
  <svg
    fill="#EE0000" // You can remove this line if you want to allow color customization later
    role="img"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
    width={44}
    height={44}
    aria-labelledby="AnsibleTitle"
  >
    <title id="AnsibleTitle">Ansible</title>
