...
interface IconProps {
  color?: string; // You can remove this if you don't need it.
}

const PowersSVG: React.FC<IconProps> = () => (
  <svg
    ...
    height={44}
    role="img"
    aria-labelledby="PowersTitle"
  >
    <title id="PowersTitle">POWERS</title>
    <path
