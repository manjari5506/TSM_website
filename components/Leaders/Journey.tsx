...
const Journey = () => {
  return (
    <section className=" z-100 relative flex flex-col items-center justify-center bg-[#f5f5f5] px-[6rem] py-[4rem] text-center">
      <div className="w-[60rem] ">
        <h3 className=" py-2 font-playfair text-5xl font-bold text-navy">
          The Evolution of Leadership
        </h3>
        <p className="text-md py-4 text-center font-semibold text-gray-700">
