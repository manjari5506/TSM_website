export const appDevelopment = {
    ...
    subheading: "Ready to build an app that drives growth for your business? Contact us today to start your app development journey.",
    image: "/images/reachout.jpg",
};
export const dataScience = {
    heading: "Let's Work Together",
    subheading: "Ready to harness the power of data for your business? Contact us today to explore how our data science solutions can drive growth and improve your decision-making processes.",
    image: "/images/reachout.jpg",
};
export const cloudDevops = {
    heading: "Let's Transform Your Infrastructure Togetherh",
    subheading: "Ready to unlock the full potential of Cloud and DevOps for your business? Get in touch with us today to discuss your cloud transformation journey!",
    image: "/images/reachout.jpg",
};
...
export const wordpress = {
    ...
    subheading: "Whether you're looking to revamp an existing site or build something new, we've got you covered. Contact us today to discuss your WordPress development project and take the first step towards digital success!",
    image: "/images/reachout.jpg",
};
...
export const uiux = {
    ...
    subheading: "Ready to create a seamless, engaging, and intuitive user experience for your product? Contact us today to bring your UI/UX vision to life and enhance your users' journey!",
    image: "/images/reachout.jpg",
};
