  ...
  return (
    <section className="Hero__section  flex h-screen flex-col ">
      <div className="relative z-10">
        <div className="  px-[9rem] pt-[12rem] ">
          ...
          <p className="w-[45rem] py-4 font-kodchasan font-semibold text-gray-800 ">
        ...
        <video
          ...
          loop
          muted
          className="absolute bottom-[9rem]  right-5   h-[25rem]  rounded-3xl   bg-cover "
        />

        <div className="mt-[7rem] flex gap-9 border-t-2  border-red-500 py-2">
