          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero font-playfair ">
                UNLIKE ANYTHING
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full  dark:before:bg-titlebgdark">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_left relative mx-auto hidden aspect-[850/500] md:block md:w-1/2"
            >
              <video
