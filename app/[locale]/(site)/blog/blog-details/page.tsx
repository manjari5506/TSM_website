        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex flex-row gap-4">
            <div className="md:w-1/2 lg:w-[32%]">
              <div className="animate_top mb-10 rounded-md bg-white p-3.5 shadow-solid-13">
                <form
                ...
                >
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke px-6 py-4 shadow-solid-12 focus:outline-none"
                    />
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md bg-white  ml-2 ">
                ...
                <h2 className="mb-5 mt-11 text-3xl font-semibold text-black dark:text-white 2xl:text-sectiontitle2 font-playfair">
                ...
                <div className="blog-details">
                  ...
                  <h3 className="pt-8 font-playfair">
