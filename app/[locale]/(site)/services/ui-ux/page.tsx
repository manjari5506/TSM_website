    ...
    <section className="bg-beige2 ">
      <div className="relative  mb-[10rem] py-15">
        <div className="relative z-1 w-[50rem] px-[10rem] pt-[12rem] ">
          ...
          <p className="text-md pt-4 text-navy ">
      ...
      <Offerings offerings={uiuxOfferings} type="appservices" />
      <TechStack techStackData={uiuxStack} type="appservices" />
      ...
      <section className="px-[6rem]  ">
        ...
        <Cards details={uiuxApproach} type="appservices" />
      </section>
