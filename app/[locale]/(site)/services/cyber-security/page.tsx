...
const page = () => {
  return (
    <>
        ...
        <div className="relative  mx-auto mb-[5rem] flex w-[90%] flex-row">
          <div className="relative z-1 w-[50rem] px-[5rem] pt-[15rem] text-left">
            <h1 className="hero-heading py-2 text-left font-playfair text-4xl font-bold">
              Defend Your Business with <br></br>World-Class Cybersecurity
              Solutions
            </h1>
            <p className="py-3 text-lg text-navy">
              Ensure your digital assets are secure with our advanced
              cybersecurity services. From network protection to endpoint
              security, we safeguard your business against cyber threats.
            </p>
      ...
      <Offerings offerings={cyberSecurityOfferings} type="appservices" />
      <TechStack techStackData={cyberSecurityStack} type="appservices" />
      <Cards details={cyberSecurityApproach} type="appservices" />
      {/* <Expertise/> */}
      <ReachOut
        type="appservices"
