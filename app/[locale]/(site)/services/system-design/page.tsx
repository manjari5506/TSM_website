...
const page = () => {
  return (
    <>
      <section className=" bg-grey pb-10">
        <div className="relative mx-auto w-[90%] mb-[5rem] flex flex-row">
          <div className="relative z-1 w-[50rem] px-[5rem] pt-[15rem] text-left">
            ...
            Take your business to the next level by hiring our expert system architects and leveraging our comprehensive system design services. Our solutions ensure scalability, 
            performance, and reliability to meet the evolving demands of your business.
            </p>
      ...
      <Offerings offerings={systemDesignOfferings}/>
      <TechStack techStackData={systemDesignStack}/>
      <Cards details={systemDesignApproach}/>
      <ReachOut 
